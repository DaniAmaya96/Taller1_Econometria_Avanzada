...
abstract: "Nota: Para el desarrollo de este taller se usó IA para garantizar el ajuste del formato de las tablas a PDF con la librería kableExtra y model summary pues al reportar los resultados en ocasiones obteniamos un errore en el codigo. Por ejemplo en el punto 4 del tercer ejercicio duramos bastante tiempo intentando entender como solucionar un problema al usa rbind con los outputs obtenidos con la funcion feols del paquete fixest. Para generar el bucle del punto 7 del ejercicio dos tambien nos apollamos en la IA, intentando comprender la sintaxis del proceso. En cuanto a notación es muy probable que se identifiquen incosistencias."
format: 
  html:
    theme: flatly
    toc: true
